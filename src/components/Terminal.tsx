...
const COMMANDS: Record<string, () => HistoryLine[]> = {
  ...
  whoami: () => [
    { type: 'success', text: '  ╔═══════════════════════════════════════════════════════╗' },
    { type: 'success', text: '  ║         RAJASHEKHAR AMARAPPAGOL                       ║' },
    { type: 'success', text: '  ║   Web Developer & System Designer                     ║' },
    { type: 'success', text: '  ╚═══════════════════════════════════════════════════════╝' },
    { type: 'spacer',  text: '' },
    { type: 'output',  text: '  › Role      :  Web Developer & System Designer' },
    { type: 'output',  text: '  › Stack     :  HTML5 · CSS3 · Firebase · MongoDB · AI-Assisted' },
    { type: 'output',  text: '  › Location  :  Vijayapura / Bengaluru, Karnataka' },
    { type: 'output',  text: '  › Status    :  Seeking Web Dev / Full-Stack Opportunities 🟢' },
    { type: 'spacer',  text: '' },
    { type: 'info',    text: '  Final-year BCA student passionate about designing systems' },
    { type: 'info',    text: '  and building clean, responsive web applications.' },
    { type: 'info',    text: '  Leads database schema design, security rules, and UI workflows.' },
    { type: 'spacer',  text: '' },
  ],

  skills: () => [
    { type: 'info',    text: '  ── CORE & LANGUAGES (Hands-on) ─────────────────' },
    { type: 'success', text: '  ● HTML5       ● CSS3       ● JavaScript (Basics)' },
    { type: 'success', text: '  ● Python (Basics)          ● SQL' },
    { type: 'spacer',  text: '' },
    { type: 'info',    text: '  ── BACKEND & DATABASES (Hands-on) ──────────────' },
    { type: 'success', text: '  ● Firebase (Firestore, Auth, Hosting)' },
    { type: 'success', text: '  ● MongoDB     ● REST APIs  ● System Architecture' },
    { type: 'spacer',  text: '' },
    { type: 'info',    text: '  ── AI-ASSISTED FRAMEWORKS (Antigravity) ────────' },
    { type: 'success', text: '  ● React.js    ● TypeScript ● Next.js' },
    { type: 'success', text: '  ● Tailwind    ● Three.js / React Three Fiber' },
    { type: 'spacer',  text: '' },
    { type: 'info',    text: '  ── DEVELOPER TOOLS & PLATFORMS ─────────────────' },
    { type: 'success', text: '  ● Google Antigravity       ● Git & GitHub' },
    { type: 'success', text: '  ● VS Code                  ● Vercel' },
    { type: 'spacer',  text: '' },
  ],

  projects: () => [
    { type: 'info',    text: '  ── TECHNICAL PROJECTS ──────────────────────────' },
    { type: 'spacer',  text: '' },
    { type: 'success', text: '  [01] APEX — AI-Powered Career Planning Platform' },
    { type: 'output',  text: '       3D Career Roadmap OS synthesizing 30-day curriculums via LLMs' },
    { type: 'output',  text: '       Stack: Google Antigravity · R3F · TypeScript · LLM APIs · GSAP' },
    { type: 'output',  text: '       Repo : github.com/rajashekharexe/Apex' },
    { type: 'spacer',  text: '' },
    { type: 'success', text: '  [02] KAD MULTIPLIER (Soil Multiplier) — E-Commerce' },
    { type: 'output',  text: '       Agricultural e-commerce with real-time Firestore synchronization' },
    { type: 'output',  text: '       Stack: Firebase · Firestore · Auth · React · Tailwind CSS' },
    { type: 'output',  text: '       Repo : github.com/rajashekharexe/Soil-Multiplier-' },
    { type: 'spacer',  text: '' },
    { type: 'success', text: '  [03] DEVELOPER PORTFOLIO — 3D Interactive Web App' },
    ...
    { type: 'output',  text: '       Live : rajashekhar-portfolio-iota.vercel.app' },
    { type: 'spacer',  text: '' },
  ],

  experience: () => [
    { type: 'info',    text: '  ── EDUCATION & AWARDS ──────────────────────────' },
    { type: 'spacer',  text: '' },
    { type: 'success', text: '  Bachelor of Computer Applications (BCA)  (2024 → 2027)' },
    { type: 'output',  text: '  A S Patil College of Commerce (Autonomous), Vijayapura' },
    { type: 'output',  text: '  Coursework: Full-Stack Dev, NoSQL (MongoDB), Data Structures, SDLC' },
    { type: 'spacer',  text: '' },
    { type: 'success', text: '  🏆 4th Place (out of 69 Teams) — IEEE AI Arena 2.0' },
    { type: 'output',  text: '  IEEE Student Branch, BLDEA CET Vijayapura (Mar 2026)' },
    { type: 'output',  text: '  Judged top 6% on system architecture, model integration & UX' },
    { type: 'spacer',  text: '' },
  ...
  contact: () => [
    ...
    { type: 'success', text: '  📍  Location :  Vijayapura / Bengaluru, Karnataka' },
