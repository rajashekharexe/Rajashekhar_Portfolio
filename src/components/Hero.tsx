          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-5 flex flex-col gap-6">
              ...
              <h1 className="text-[3.5rem] md:text-[4.5rem] lg:text-[5.5rem] leading-[0.85] font-display font-black uppercase tracking-tighter mb-2 text-black flex flex-col items-start">
                ...
                <div className="overflow-hidden pb-2" style={{ perspective: 1200 }}>
                  <motion.div 
                    ...
                    style={{ transformOrigin: "top center" }}
                  >
                    <TextRepel text="Web" radius={120} strength={40} />
                  </motion.div>
                </div>
                <div className="overflow-hidden pb-2" style={{ perspective: 1200 }}>
                  <motion.div 
                ...
                <div className="overflow-hidden pb-2" style={{ perspective: 1200 }}>
                  <motion.div 
                    ...
                    style={{ transformOrigin: "top center" }}
                  >
                    <TextRepel text="& Designer" radius={120} strength={40} />
                  </motion.div>
                </div>
              </h1>
            ...
            >
              ...
              <div className="flex items-center flex-wrap gap-6 text-black font-semibold text-sm">
                <a href="/resume.pdf" download="Rajashekhar_Amarappagol_Resume.pdf" className="bg-primary text-white px-6 py-3 rounded-full hover:bg-neutral-800 transition-colors uppercase tracking-widest text-[10px] md:text-xs">Download CV</a>
          ...
          <div className="col-span-12 md:col-span-5 md:col-start-8 lg:col-span-5 lg:col-start-8 flex flex-col gap-6 md:gap-8 pt-2 md:pt-4 pb-4 z-20">
              ...
              <h3 className="font-display font-black text-4xl md:text-5xl uppercase leading-[0.9] tracking-tight mb-2 text-foreground flex flex-col items-start">
                <div className="overflow-hidden pb-1" style={{ perspective: 1000 }}>
                  <motion.div variants={{ hidden: { y: "120%", rotateX: -90, opacity: 0 }, visible: { y: "0%", rotateX: 0, opacity: 1, transition: { duration: 1.1, ease: [0.76, 0, 0.24, 1] } } }} style={{ transformOrigin: "top center" }}>
                    <TextRepel text="System" radius={90} strength={30} />
                  </motion.div>
                </div>
                <div className="overflow-hidden pb-1" style={{ perspective: 1000 }}>
                  <motion.div variants={{ hidden: { y: "120%", rotateX: -90, opacity: 0 }, visible: { y: "0%", rotateX: 0, opacity: 1, transition: { duration: 1.1, ease: [0.76, 0, 0.24, 1] } } }} style={{ transformOrigin: "top center" }}>
                    <TextRepel text="Designer" radius={90} strength={30} />
                  </motion.div>
                </div>
              </h3>
              <motion.p variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }} className="text-sm md:text-base text-black font-medium leading-relaxed">Designing database schemas, Firebase security rules, and end-to-end user workflows.</motion.p>
            </motion.div>
            ...
            >
              <h3 className="font-display font-black text-4xl md:text-5xl uppercase leading-[0.9] tracking-tight mb-2 text-foreground flex flex-col items-start">
                <div className="overflow-hidden pb-1" style={{ perspective: 1000 }}>
                  <motion.div variants={{ hidden: { y: "120%", rotateX: -90, opacity: 0 }, visible: { y: "0%", rotateX: 0, opacity: 1, transition: { duration: 1.1, ease: [0.76, 0, 0.24, 1] } } }} style={{ transformOrigin: "top center" }}>
                    <TextRepel text="AI-Assisted" radius={90} strength={30} />
                  </motion.div>
                </div>
                <div className="overflow-hidden pb-1" style={{ perspective: 1000 }}>
                  <motion.div variants={{ hidden: { y: "120%", rotateX: -90, opacity: 0 }, visible: { y: "0%", rotateX: 0, opacity: 1, transition: { duration: 1.1, ease: [0.76, 0, 0.24, 1] } } }} style={{ transformOrigin: "top center" }}>
                    <TextRepel text="Stack" radius={90} strength={30} />
                  </motion.div>
                </div>
              </h3>
              <motion.p variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }} className="text-sm md:text-base text-black font-medium leading-relaxed">Building with Google Antigravity, React, TypeScript, and Three.js physics.</motion.p>
            </motion.div>
            ...
            >
              <h3 className="font-display font-black text-4xl md:text-5xl uppercase leading-[0.9] tracking-tight mb-2 text-foreground flex flex-col items-start">
                <div className="overflow-hidden pb-1" style={{ perspective: 1000 }}>
                  <motion.div variants={{ hidden: { y: "120%", rotateX: -90, opacity: 0 }, visible: { y: "0%", rotateX: 0, opacity: 1, transition: { duration: 1.1, ease: [0.76, 0, 0.24, 1] } } }} style={{ transformOrigin: "top center" }}>
                    <TextRepel text="Shipped" radius={90} strength={30} />
                  </motion.div>
                </div>
                <div className="overflow-hidden pb-1" style={{ perspective: 1000 }}>
                  <motion.div variants={{ hidden: { y: "120%", rotateX: -90, opacity: 0 }, visible: { y: "0%", rotateX: 0, opacity: 1, transition: { duration: 1.1, ease: [0.76, 0, 0.24, 1] } } }} style={{ transformOrigin: "top center" }}>
                    <TextRepel text="Live" radius={90} strength={30} />
                  </motion.div>
                </div>
              </h3>
              <motion.p variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }} className="text-sm md:text-base text-black font-medium leading-relaxed">Multiple production apps deployed on Vercel and Firebase with 95+ Lighthouse performance.</motion.p>
            </motion.div>
